...
- 위치별 조사 상태와 공식 근거 링크
- NVIDIA NIM 기반 AI 요약(선택 기능, 본관별 유명인 DB 참조)
...
- `prisma/famous-data.json` — 위키백과 본관 문서 `주요 인물` + Wikidata 연예인(`P53`→본관) + 민족문화대백과 인물(`본관` 필드) 11,449명, 687개 본관 (CC BY-SA 4.0 + CC0 + 공공저작물 자유이용, 출처: ko.wikipedia.org·wikidata.org·encykorea.aks.ac.kr)
